...
void AProInstanceToolsParent::SetupInstances()
{
	...
	for (int i = 0; i < ObjectsCount; i++)
	{
		...
		case 1:
			...
			ISMComponent->CreationMethod = EComponentCreationMethod::SimpleConstructionScript;
			ISMComponent->bAutoRegister = true;
...
//			ISMComponent->SetIsReplicated(true);
		...
		case 2:
			...
			HISMComponent->CreationMethod = EComponentCreationMethod::SimpleConstructionScript;
			HISMComponent->bAutoRegister = true;
...
//	bool bOverlappingSelf = false;
	...
	case 0:
		...
		SMComponent->bAutoRegister = true;
		SMComponent->CreationMethod = EComponentCreationMethod::SimpleConstructionScript;
	...
	case 3:
		...
		ClassComponent->CreationMethod = EComponentCreationMethod::SimpleConstructionScript;
		ClassComponent->bAutoRegister = true;
