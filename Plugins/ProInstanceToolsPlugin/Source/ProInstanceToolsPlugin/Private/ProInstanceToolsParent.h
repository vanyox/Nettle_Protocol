...
UENUM(BlueprintType)
enum EProInstanceRotationType
{
	RotationType_RandomFromRange UMETA(DisplayName = "Random From Range"),
	RotationType_RandomFromList UMETA(DisplayName = "Random From List")
...
struct FProInstanceRotation
{
	...
	*/
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Tools", DisplayName = "Rotation Type")
	TEnumAsByte<EProInstanceRotationType> RotationType = RotationType_RandomFromRange;

	/** Min random rotation in range. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Tools", DisplayName = "Rotation Range Min", meta = (EditCondition = "RotationType == EProInstanceRotationType::RotationType_RandomFromRange"))
	FRotator RotationRangeMin = FRotator(0, 0, 0);

	/** Max random rotation in range. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Tools", DisplayName = "Rotation Range Max", meta = (EditCondition = "RotationType == EProInstanceRotationType::RotationType_RandomFromRange"))
	FRotator RotationRangeMax = FRotator(0, 0, 0);

	/** Contains the list of rotation values to choose from. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Tools", DisplayName = "Rotation List", meta = (EditCondition = "RotationType == EProInstanceRotationType::RotationType_RandomFromList"))
	...
	TEnumAsByte<EProInstanceRotateToActorByAxes> RotateToActorByAxes = RotateToActorByAxes_XYZ;

	FProInstanceRotation()
	{
		RotationList.Add(FRotator(0.0f, 0.0f, 0.0f));
		RotationList.Add(FRotator(0.0f, 90.0f, 0.0f));
		RotationList.Add(FRotator(0.0f, 180.0f, 0.0f));
		RotationList.Add(FRotator(0.0f, 270.0f, 0.0f));
	}
};
...
struct FProInstanceInstance
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Tools", DisplayName = "Overwrite Materials", meta = (InlineEditConditionToggle, ScriptName = "Enable Overwrite Materials"))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Pro Instance Main Settings|Instances", DisplayName = "Use Local Instance Settings", meta = (InlineEditConditionToggle, ScriptName = "Use Local Instance Settings"))
